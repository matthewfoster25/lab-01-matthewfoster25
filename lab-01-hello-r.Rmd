...
Answer: The 'datasaurus_dozen' file has 1846 rows and 3 variables. The variables are **dataset**, **x**, and **y**.
...
Answer: The correleation coefficient between 'x' and 'y' for this dataset is -0.06447185.
...
```{r fig.fullwidth=TRUE, fig.height=3, fig.width=6}
...
Answer: The correlation coefficient between 'x' and 'y' for the dataset *star* is -0.0629611	. In comparison to the dataset *dino* this is very similar numerically but is also bigger measuring nearly 0.0015 more.
...
Answer: The correlation coefficient between 'x' and 'y' for the dataset *circle* is -0.06834336. In comparison to the dataset *dino*, the value of *circle* is smaller, measuring nearly 0.004 less.
...
```{r all-viz, eval=FALSE, fig.fullwidth=TRUE, fig.height=3, fig.width=6}
